...
| Beacon fetches | Ordinary HTTP (`fetch` / channels) to poisoner endpoints | P3 pin 1 + **`0024`** | No TLS/JA3 games; no Cloudflare claims; **0024** richer GA/GA4/Meta query parity (WebExt may remain richer for ISOLATED sendBeacon + DOM chaff) |
...
M4 API: `duppel_chaff::ChaffSchedulerPlan` / `duppel_bridge::read_depth_seeds` / `m4_depth_surfaces`. Live timer: [`0016-…`](../patches/0016-darkstr-chaff-native-scheduler.patch). Live richer beacons: [`0024-…`](../patches/0024-darkstr-chaff-richer-beacon-bodies.patch). Live depth (canvas/WebGL/Audio): [`0017-…`](../patches/0017-darkstr-depth-canvas-webgl-audio.patch). Live workers: [`0018-…`](../patches/0018-darkstr-worker-globals-coherence.patch). Live WebGL caps/OffscreenCanvas: [`0023-…`](../patches/0023-darkstr-depth-webgl-caps-offscreencanvas.patch). Live WebGL context enable (LibreWolf hardening undo): [`0029-…`](../patches/0029-darkstr-webgl-context-enable.patch) · [`PHASE-3-STATUS.md`](PHASE-3-STATUS.md). Leftovers stub: [`0004-…`](../patches/stubs/0004-darkstr-chaff-depth.patch.stub) · [`M4-STATUS.md`](M4-STATUS.md).
