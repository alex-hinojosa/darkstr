...
if [[ "${stub_count}" -gt 0 ]]; then
  ...
  echo "Remaining stubs are sketches; real patches: 0002 XOR, 0003 chrome persona, 0005 C++ nsHttp, 0006/0007 C++ nav/docshell, 0008/0009 FFI link when present (0004 stub=chaff)."
fi
